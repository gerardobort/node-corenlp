  ...
  constructor(options = {}) {
    super(
      "openie",
      {
        ...
        resolve_coref: false, //	(boolean)	false  	If true, run coreference (and consequently NER as a dependency of coreference) and replace pronominal mentions with their canonical mention in the text.
        ...
        triple: { all_nominals: false }, //  	If true, extract nominal relations always and not only when a named entity tag warrants it. This greatly overproduces such triples, but can be useful in certain situations.
