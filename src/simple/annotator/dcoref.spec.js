...
describe('Annotator', () => {
  ...
  describe('DeterministicCorefAnnotator', () => {
    beforeEach(() => annotator = new DeterministicCorefAnnotator());

    it('should have a proper pipeline', () => {
      expect(annotator.pipeline()).to.deep.equal(['tokenize', 'ssplit', 'pos', 'lemma', 'ner', 'parse', 'depparse', 'relation', 'dcoref']);
    });
